...
import AssignProvision from "_components/organisms/assign.provision";
...
const AssignProvisionScreen = ({ navigation }) => {
      ...
      <ScrollView>
        {loading ? (
          ...
          <View style={{ width: "100%", height: "100%" }}>
            ...
            <AssignProvision navigation={navigation} />
          </View>
        )}
      </ScrollView>
    </SafeAreaView>
...
export default AssignProvisionScreen;
