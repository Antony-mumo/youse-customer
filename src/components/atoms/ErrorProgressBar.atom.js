...
import { DEEP_BLUE, GRAY_MEDIUM, WHITE, ORANGE } from "_styles/colors";
 ...
 */
const ErrorProgressBarAtom = (props) => {
    ...
    <>
      <View style={styles.main}>
        <View style={styles.container}>
          ...
          {active == true && (
            <View style={[styles.bar, styles.orangeBar]}></View>
          )}
          <View
            style={[
              styles.circle,
...
export default ErrorProgressBarAtom;
